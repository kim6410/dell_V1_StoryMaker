...
from app.beta_archive_retention import start_beta_archive_retention_scheduler
...
def start_beta_archive_retention_on_startup() -> None:
    start_beta_archive_retention_scheduler()
