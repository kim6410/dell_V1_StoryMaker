...
- 현재의 날짜를 자연스럽게 표현한다. (7월 말 수요일 저녁, 7월 초순 금요일 저녁, 목요일 이른아침의 30도를 넘는 무더운 날씨, 주말 오후에 선선한 날씨 등)
...
- 사용할 수 있는 표현 예시는 우아~~~, 오~~, 아~~, 하하~, 정말이요???, 어머머??, 음~~, 맞아요!!, 같은 짧은 반응입니다.
- PODCAST_50에는 이런 톤 표현을 4회에서 5회 정도 사용합니다.
- PODCAST_80에는 이런 톤 표현을 5회에서 6회 정도 사용합니다.
