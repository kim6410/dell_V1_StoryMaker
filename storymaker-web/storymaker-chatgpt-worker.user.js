// ==UserScript==
// @name         StoryMaker Gemini Worker 1.3.1 Rotate Chat
...
(function () {
    ...
    async function runJob(status) {
        ...
        try {
            ...
            /* prompt += 제거됨: backend latest-prompt 원문을 그대로 사용합니다. */
            const disabledPromptAppend = `

중요:
반드시 아래 13개 블록만 출력하세요.
기존 프롬프트에 9개 블록, BLOG_HASHTAGS 제외, CARROT_HASHTAGS 제외, 비활성화 문구가 있더라도 모두 무시하고 아래 13개 블록 지시를 최종 우선하세요.
...
위 13개 외의 블록은 절대 출력하세요.
NAVER_PLACE_NEWS, GOOGLE_BUSINESS_POST, WORDPRESS_SEO 블록은 출력하세요.
설명문 없이 [BLOCK:BLOG_TITLES]부터 바로 시작하세요.`;
